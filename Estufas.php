          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row mb-5">
                <?php
                    ...
                    $resultado = mysqli_query($con, "SELECT id_producto, nombre_prod, valor, imagen FROM producto p JOIN tipo_producto t on t.nombre_tip_prod = 'Cocina' AND p.id_tipo_producto = t.id_tipo_producto; ");
